        ...
        {tasksData ? (
          <Fragment>
            {tasksData?.tasks.length !== 0 ? (
              ...
              <Col className="d-flex justify-content-center align-items-center no-task-msg">
                Do not have todo tasks. Please add new task!
              </Col>
            )}
          </Fragment>
        ) : (
          <Col className="d-flex justify-content-center align-items-center no-task-msg text-danger">
